...
class Program2
{
    static void Main(string[] args)
    {
        ...
        Console.WriteLine("{0,-3}{1,-25}{2,-3}{3,-3}{4,-3}{5,-3}{6,-3}{7,-4}{8,-5}{9,-4}{10,-10}", "Pos", "Team", "GP", "W", "L", "D", "GF", "GA", "GD", "Pts", "Streak");
        for (int i = 0; i < sortedTeams.Count; i++)
        {
            ...
            // Write team row
            Console.WriteLine("{0,-3}{1,-25}{2,-3}{3,-3}{4,-3}{5,-3}{6,-3}{7,-4}{8,-5}{9,-4}{10,-10}", i + 1, team?.Name, team?.GamesPlayed, team?.GamesWon, team?.GamesLost, team?.GamesDrawn, team?.GoalsFor, team?.GoalsAgainst, team?.GoalDifference, team?.Points, team?.CurrentStreak);
